...
<main>
	<?php
		...
		$country="";
		//assigning variables
		if(isset($_POST['fname']) && isset($_POST['lname']) && isset($_POST['pass1']) && isset($_POST['pass2']) && isset($_POST['email1']) && isset($_POST['email2']) && isset($_POST['gender']) && isset($_POST['country'])) {
			$fname = $_POST['fname'];
			$lname = $_POST['lname'];
			$gender = $_POST['gender'];
